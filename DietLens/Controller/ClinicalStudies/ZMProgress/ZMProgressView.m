...
-(void)drawText{
    ...
    [title addAttribute:NSFontAttributeName
                  value:[UIFont systemFontOfSize:20 * FontScale]
                  range:titleRange];
    ...
    NSMutableAttributedString* precentStr = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",self.percentUnit]];
